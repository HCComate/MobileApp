...
export default function YearlyStatisticsScreen() {
  ...
  useEffect(() => {
    const loadData = async () => {
      const data = await fetchInspectionStats("yearly");
  ...
  if (loading || !inspectionData) {
    return (
      <View style={styles.center}>
        ...
        <Text style={styles.loadingText}>연간 검사 통계 가동 중...</Text>
      </View>
    );
  }
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={["top", "right", "left"]}>
      ...
      <PageHeader title="연간 검사 통계" showBack={true} />
      ...
      >
        <View style={styles.summaryGrid}>
          ...
          >
            <Text style={styles.cardLabel}>연간 총 검사수</Text>
        ...
        <View style={styles.section}>
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <Text style={styles.sectionTitle}>연간 종합 판정 비율</Text>
        ...
        <View style={styles.section}>
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <Text style={styles.sectionTitle}>연간 장기 가동 분석 지표</Text>
            <Text style={styles.arrowIcon}>
